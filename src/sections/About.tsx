...
const About = () => {
    return (
        <section id="about">
            ...
            <div className="flex flex-col lg:flex-row justify-center items-center lg:items-start max-w-[70vw] lg:max-w-[60vw] gap-10 md:gap-20 py-[5svh] md:py-[12 vh] mx-auto lg:relative">
                <AsciiPortrait />
                <div>
                    ...
                    <p className="mb-4">
                        ...
                        j'assimile. Mon parcours à l'ECV Paris en tant que Chef de Projet Digital, ainsi que mon
                        parcours OpenClassrooms de Développeur Web m'ont permis de déployer mes ailes.
                    </p>
                    <p>
