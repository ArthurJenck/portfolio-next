...
import { BOTTOM_MARGIN_PX, FAST_TRAVEL_SECTIONS, VISIBILITY_THRESHOLD_DIVISOR } from './fastTravel.config'
...
const FastTravel = () => {
    ...
    useEffect(() => {
        ...
        const updateCurrentSection = () => {
            ...
            setIsVisible(scrollY > windowHeight / VISIBILITY_THRESHOLD_DIVISOR)
            ...
            if (scrollHeight - scrollY - windowHeight < BOTTOM_MARGIN_PX) {
