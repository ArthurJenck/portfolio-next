...
// Durée de la transition embla du slider de projet (0 en reduced-motion).
export const EMBLA_DURATION = 25

// Délai après relâchement du drag avant de réactiver le suivi du scroll par le carousel.
export const DRAG_END_TIMEOUT_MS = 300
