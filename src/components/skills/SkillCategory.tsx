...
const SkillCategory = ({ name, truncatedName, skills }: SkillCategoryProps) => {
    return (
        <div className="w-fit relative left-[5.5vw] lg:left-[15vw] top-0 mt-[7svh] lg:mt-[13svh]">
            <h3 className="md:hidden font-bold sticky top-[50svh] text-[clamp(1.2rem,2.5vw,2.5vw)] float-left text-right tracking-[2px] min-w-16 bg-[var(--primary)] z-10">
                {truncatedName}
            </h3>
            <h3 className="hidden md:block font-bold sticky top-[50svh] text-[2.5vw] float-left text-right tracking-[2px] min-w-[clamp(120px,14vw,14vw)] bg-[var(--primary)] z-10">
                {name}
            </h3>
